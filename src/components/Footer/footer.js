    ...
    <div className="bg-footer-100 ">
      <div className="max-w-2xl mx-auto text-white py-10">
        <div className="text-center">
          <h3 className="text-xl lg:text-3xl text-footer-200 jost-category">
            {" "}
            Download our Ecommerce app{" "}
          </h3>
          <div className="flex justify-center my-10">
            <div className="flex items-center border border-gray-300 w-auto rounded-lg px-2 py-2 w-52 mx-2">
              <img
            ...
            <div className="flex items-center border border-gray-300 w-auto rounded-lg px-2 py-2  mx-2">
              <img
          ...
          <h3 className="text-lg lg:text-2xl mb-1 jost-category">
        ...
        <div className="mt-8 flex flex-col md:flex-row md:justify-between items-center text-sm md:text-md lg:text-lg text-gray-300 font-about">
          <p className="order-2 md:order-1 mt-8 md:mt-0">
            {" "}
            help.fashiondiva@gmail.com
          </p>
          <div className="flex flex-row order-1 md:order-2">
            ...
            <a
              href="https://www.instagram.com/ankit_bisen18/"
              target="_blank"
              rel="noreferrer"
            >
