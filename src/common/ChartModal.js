...
const ChartModal = (props) => {
  ...
  return (
    <Transition.Root show={open} as={Fragment} className="jost-category">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="overflow-x-auto">
                      <table className="min-w-full bg-white shadow-md">
                        <thead>
                          <tr className="bg-gray-100 text-gray-700 text-lg lg:text-xl border-b border-blue-gray-200">
                        ...
                        <tbody className="text-blue-gray-900">
                          {chart.map((el) => (
                            <tr className="border-b border-blue-gray-200 text-center">
                              <td className="py-3 px-4">{el.size}</td>
                              <td className="py-3 px-4">{el.chest}</td>
                              <td className="py-3 px-4">{el.length}</td>
                              <td className="py-3 px-4">{el.shoulder}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
